...
public class WarehouseRest  extends JFrame implements ActionListener{
      ...
      public void dataHandlingGuiApiAddItem(){
            try {
                  String s = field_5.getText();
                  int available =Integer.parseInt(s) ;
                  String name = field_4.getText();
                  String description = field_7.getText();
                  Item newItem = new Item();newItem.setName(name);newItem.setAvailable(available);newItem.setDescription(description);
                  System.out.println(newItem.getName()+" "+newItem.getAvailable()+" "+newItem.getDescription()+" "+newItem.getCreatedAt());  
      ...
      public void updateItem(){
            try {
                  ...
                  request = new UpdateItemRequest(item.getName(),item.getAvailable(), item.getDescription());  
